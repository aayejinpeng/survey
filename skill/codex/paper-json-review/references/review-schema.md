...
Include `field_reviews` for these dossier sections:
...
Use `issues` for pinpointed problems such as a fabricated quote, incorrect number, or unsupported conclusion.
